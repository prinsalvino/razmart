                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									<div class='product-img'>
										<img src='product_images/$pro_image' style='max-height: 300px;' alt=''>
									</div></a>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 "><img src="product_images/'.$product_image.'" style="width:100px;"/>
									</div>
									<div class="col-sm-6">
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="razmart@gmail.com">
